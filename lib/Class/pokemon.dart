//JSON dosyasını kullanabilmek için "https://javiercbk.github.io/json_to_dart/ "
// adresine gidip JSON dosyasını Dart diline çeviriyoruz.

class PokemonWorld {
  List<Pokemon> pokemon;

  PokemonWorld({this.pokemon});

  PokemonWorld.fromJson(Map<String, dynamic> json) {
